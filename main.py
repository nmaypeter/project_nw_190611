        ...
        for cm in cm_seq:
            ...
            for prod_setting in prod_seq:
                ...
                for wd in wd_seq:
                    ...
                    Model('mmioaepw', dataset_name, product_name, cascade_model, wallet_distribution_type).model_mioaepw(r_flag=False)
                    Model('mmioarepw', dataset_name, product_name, cascade_model, wallet_distribution_type).model_mioaepw(r_flag=True)
